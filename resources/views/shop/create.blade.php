    ...
    <div class="col-md-12">
       <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex align-items-center">   
                <h6 class="m-0 font-weight-bold text-primary">Add {{ $page_title}}</h6>
            </div>
            <div class="card-body">
                <form method="post" action="{{ url('admin/shop') }}" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 mx-auto">
                        ...
                        <div class="form-group row">                                    
                            <div class="col-sm-12">
                                <img class="img-thumbnail" id="thumb_img" alt="no-image" style="width:100%" src="{{ asset('assets/backend/images/no-image.jpg') }}" data-holder-rendered="true">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-12">
